        ...
        <div id="view" v-if="!editing">
            <div class="form-row align-items-center">
                <div class="col col-sm-1">
                    <input v-if="parent.id!=0" id="name" type="text" class="form-control-plaintext" v-model="parent.id" disabled>
                </div>
                <div class="col col">
                    <input id="name" type="text" class="form-control" v-model="parent.name" disabled>
                </div>
                <div class="col col-sm-5">
                    <input id="name" type="text" class="form-control" v-model="parent.home_id" disabled>
                </div>
        ...
        <div id="edit" v-if="editing">
            <div class="form-row align-items-center">
                <div class="form-group col col-sm-1">
                    ...
                    <input id="name" type="text" class="form-control-plaintext" v-model="editableParent.id" disabled>
                </div>
                ...
                <div class="form-group col-sm-5">
                    ...
                    <input id="name" type="text" class="form-control" v-model="editableParent.home_id">
                </div>
